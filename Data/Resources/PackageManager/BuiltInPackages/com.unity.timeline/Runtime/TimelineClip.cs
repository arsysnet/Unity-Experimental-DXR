...
namespace UnityEngine.Timeline
{
    ...
    {
        // called __BY THE EDITOR__ when a clip is create to initialize defaults. It is called prior to the
        //  clip being added to the track
        // resolver may be null (asset mode)
    ...
    public partial class TimelineClip : ICurvesOwner, ISerializationCallbackReceiver
    {
        ...
        public double timeScale
        {
            ...
            set { m_TimeScale = clipCaps.HasAny(ClipCaps.SpeedMultiplier) ? Math.Max(kTimeScaleMin, Math.Min(value, kTimeScaleMax)) : 1.0; }
        }
        ...
        public double duration
        {
            ...
            set { m_Duration = Math.Max(SanitizeTimeValue(value, m_Duration), double.Epsilon); }
        }
        ...
        public double clipIn
        {
            ...
            set { m_ClipIn = clipCaps.HasAny(ClipCaps.ClipIn) ? Math.Max(Math.Min(SanitizeTimeValue(value, m_ClipIn), kMaxTimeValue), 0.0) : 0; }
        }
        ...
        public double easeInDuration
        {
            ...
            set { m_EaseInDuration = clipCaps.HasAny(ClipCaps.Blending) ? SanitizeTimeValue(value, m_EaseInDuration) : 0; }
        }
        ...
        public double easeOutDuration
        {
            ...
            set { m_EaseOutDuration = clipCaps.HasAny(ClipCaps.Blending) ? SanitizeTimeValue(value, m_EaseOutDuration) : 0; }
        }
