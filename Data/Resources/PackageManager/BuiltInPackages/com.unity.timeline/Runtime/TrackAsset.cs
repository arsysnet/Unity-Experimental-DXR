...
namespace UnityEngine.Timeline
{
    ...
    {
        const string k_DefaultCurvesName = "Track Parameters";
        ...
        {
            get { return locked || parentLocked; }
        }
        ...
        internal bool parentLocked
        {
            get
            {
                ...
                return parentTrack != null && parentTrack.lockedInHierarchy;
            }
        }
        ...
        public void CreateCurves(string curvesClipName)
        {
            ...
            m_Curves = TimelineCreateUtilities.CreateAnimationClipForTrack(string.IsNullOrEmpty(curvesClipName) ? k_DefaultCurvesName : curvesClipName, this, true);
        }
        ...
        internal bool IsCompilable()
        {
            ...
            var ret = !muted && (CanCompileClips() || CanCompileNotifications());
            if (!ret)
            {
