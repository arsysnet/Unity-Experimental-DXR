...
namespace UnityEditor.Timeline
{
    ...
    class AnimationPlayableAssetInspector : Editor
    {
        ...
        void ShowAnimationClipWarnings()
        {
            ...
            if (clip == null)
            {
                EditorGUILayout.HelpBox(AnimationTrackDrawer.Styles.NoClipAssignedError, MessageType.Warning);
            }
            else if (clip.legacy)
            {
                EditorGUILayout.HelpBox(AnimationTrackDrawer.Styles.LegacyClipError, MessageType.Warning);
            }
        }
