...
namespace UnityEditor.Timeline
{
    ...
    class ControlPlayableInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_SourceObject.hasMultipleDifferentValues)
        ...
        void CheckForCyclicReference()
        {
            ...
            {
                if (DetectCycle(asset, director, new HashSet<PlayableDirector>()))
                {
        ...
        static IEnumerable<ControlPlayableAsset> GetPlayableAssets(PlayableDirector director)
        {
