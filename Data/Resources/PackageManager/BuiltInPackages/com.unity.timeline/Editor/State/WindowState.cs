...
namespace UnityEditor.Timeline
{
    ...
    class WindowState
    {
        ...
        {
            get { return editSequence.viewModel.trackHeight; }
            set
            {
                editSequence.viewModel.trackHeight = value;
        ...
        public void SetCurrentSequence(TimelineAsset timelineAsset, PlayableDirector director, TimelineClip hostClip)
        {
            ...
            OnCurrentDirectorWillChange(director);
        ...
        public void PopSequencesUntilCount(int count)
        {
            ...
            OnCurrentDirectorWillChange(nextDirector);
        ...
        public Rect timeAreaRect
        {
            get
            {
                var rect = m_Window.sequenceContentRect;
                rect.yMin = WindowConstants.timeAreaYPosition;
                rect.height = WindowConstants.timeAreaHeight;
                return rect;
            }
        }
        ...
        void OnCurrentDirectorWillChange(PlayableDirector nextDirector)
        {
