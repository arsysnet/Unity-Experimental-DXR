...
namespace UnityEditor.Timeline
{
    static class TimelineHelpers
    {
        ...
        {
            if (trackType == null || trackType.Namespace == null)
                return string.Empty;
            if (trackType.Namespace.Contains("UnityEngine"))
                return string.Empty;
        ...
        static void AddClipOnTrack(TimelineClip newClip, TrackAsset parentTrack, double candidateTime, Object assignableObject, WindowState state)
        {
            ...
            var initializer = newClip.asset as IClipInitializer;
            if (initializer != null)
                initializer.OnCreate(newClip, parentTrack, playableDirector);
