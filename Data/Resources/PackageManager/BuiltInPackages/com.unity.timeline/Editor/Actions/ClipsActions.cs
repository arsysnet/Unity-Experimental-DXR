...
namespace UnityEditor.Timeline
{
    ...
    class EditSubTimeline : ClipAction
    {
        ...
        bool IsValid(WindowState state, TimelineClip[] clips)
        {
            ...
            var clip = clips[0];
            var asset = clip.asset as IDirectorDriver;
            return asset != null && asset.GetDrivenDirectors(state.editSequence.director).Any();
        }
        ...
        public override bool Execute(WindowState state, TimelineClip[] clips)
        {
            ...
            var clip = clips[0];
            var directors = ((IDirectorDriver)clip.asset).GetDrivenDirectors(state.editSequence.director);
        ...
        protected override void AddSelfToMenu(GenericMenu menu, WindowState state, TimelineClip[] items)
        {
            ...
            var clip = items[0];
            var subDirectors = ((IDirectorDriver)clip.asset).GetDrivenDirectors(state.editSequence.director);
