...
namespace UnityEditor.Timeline.Signals
{
    static class Styles
    {
        ...
        public static readonly string ProjectHasNoSignalAsset = L10n.Tr("Your project contains no Signal asset");

        //Icons
        public static readonly GUIStyle OptionsStyle = "Icon.Options";
