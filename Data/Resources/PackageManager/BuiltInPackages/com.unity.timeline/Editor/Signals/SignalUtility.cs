...
namespace UnityEditor.Timeline.Signals
{
    ...
    static class SignalUtility
    {
        ...
        public static void DrawSignalNames(ISignalAssetProvider assetProvider, Rect position, GUIContent label, bool multipleValues)
        {
            ...
            var prevShowMixedValues = EditorGUI.showMixedValue;
            ...
            EditorGUI.showMixedValue = prevShowMixedValues;
        }
        ...
        public static void DrawCenteredButton(GUIContent buttonLabel, Action action)
        {
            using (new GUILayout.HorizontalScope())
            {
                GUILayout.FlexibleSpace();
