...
namespace UnityEditor.Timeline
{
    partial class TimelineWindow
    {
        ...
        Rect m_SplitterLineRect = Rect.zero;
        ...
        {
            get { return new Rect(0.0f, WindowConstants.timeAreaYPosition, position.width - WindowConstants.sliderWidth, position.height - WindowConstants.timeAreaYPosition); }
        }

        public Rect sequenceHeaderRect
        {
            get { return new Rect(0.0f, WindowConstants.timeAreaYPosition, state.sequencerHeaderWidth, position.height - WindowConstants.timeAreaYPosition); }
        }
        ...
        internal TimelineMode currentMode
        {
            get
            {
                ...
                if (!state.editSequence.director.isActiveAndEnabled)
        ...
        void TimelineSectionGUI()
        {
            ...
            {
                GUILayout.BeginHorizontal(EditorStyles.toolbarButton, GUILayout.Width(position.width - state.sequencerHeaderWidth));
                {
        ...
        void SplitterGUI()
        {
            ...
            {
                m_SplitterLineRect.Set(state.sequencerHeaderWidth - 1.0f, 0.0f, 1.0f, clientArea.height);
                EditorGUI.DrawRect(m_SplitterLineRect, DirectorStyles.Instance.customSkin.colorTopOutline3);

                m_SplitterLineRect.Set(state.sequencerHeaderWidth, 0.0f, 1.0f, clientArea.height);
                EditorGUI.DrawRect(m_SplitterLineRect, DirectorStyles.Instance.customSkin.colorTopOutline3);
            }
        }
        ...
        void OptionsGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(currentMode.headerState.options == TimelineModeGUIState.Disabled))
            {
                ...
                if (GUILayout.Button(styles.options.normal.background, EditorStyles.toolbarButton))
                {
