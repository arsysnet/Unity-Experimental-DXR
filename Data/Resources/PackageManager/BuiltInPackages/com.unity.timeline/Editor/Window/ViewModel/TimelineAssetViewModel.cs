...
namespace UnityEditor.Timeline
{
    ...
    {
        public const float DefaultTrackHeight = 30.0f;
        public const float DefaultTrackScale = 1.0f;
        public const float DefaultVerticalScroll = 0;

        public static readonly Vector2 TimeAreaDefaultRange = new Vector2(-5.0f, 5.0f); // in seconds. Hack: using negative value to force the UI to have a left margin at 0.
        ...
        public float trackHeight = DefaultTrackHeight;
