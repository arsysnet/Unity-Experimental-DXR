...
namespace UnityEditor.Timeline
{
    class TimelineWindowTimeControl : IAnimationWindowControl
    {
        ...
        float start
        {
            get { return (float)startD; }
        }


        float duration
        {
            get { return (float)durationD; }
        }
        ...
        public override AnimationKeyTime time
        {
            get
            {
                ...
                return AnimationKeyTime.Time((float)state.editSequence.time - start, state.referenceSequence.frameRate);
            }
        }
