...
namespace UnityEditor.PackageManager.UI
{
    ...
    internal class PackageInfo : IEquatable<PackageInfo>, ISerializationCallbackReceiver
    {
        ...
        {
            get { return IsCurrent || string.IsNullOrEmpty(Version.Prerelease) || HasVersionTag(PackageTag.preview) || IsVerified || IsCore; }
        }
        ...
        public string StandardizedLabel(bool showSimplified = true)
        {
            ...
            if (IsVerified && showSimplified)
                ...
                if (IsPreview)
                    ...
                    label = string.Format("{0} - ", Version.Prerelease) + label;
            return label;
        }
    }
}
