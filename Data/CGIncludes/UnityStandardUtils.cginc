    ...
    half3 ambient_contrib = 0.0;
        ...
        // Completely per-pixel
            ...
            if (unity_ProbeVolumeParams.x == 1.0)
                ambient_contrib = (unity_ProbeVolumeParams.w == 0) ? SHEvalLinearL0L1_SampleProbeVolume(half4(normal, 1.0), worldPos) : SHEvalLinearL0L1L2_SampleProbeVolume(half4(normal, 1.0), worldPos);
            else
